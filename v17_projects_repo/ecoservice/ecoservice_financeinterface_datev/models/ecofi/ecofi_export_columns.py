...
class EcofiExportColumns(models.AbstractModel):
    ...
    def get_legal_datev_header(self, ecofi):
        ...
        if not ecofi.company_id.sudo().chart_template:
            raise exceptions.UserError(_(
        ...
        chart_of_accounts = ecofi.sudo().company_id.chart_template
        skr_no = (
    ...
    def get_datev_column_headings(self):
        print("\n\n\nget_datev_column_headings------------------column----------------------")
        """
    ...
    def get_datev_export_line(self, datev_dict):
        print("\n\n\nget_datev_export_line--------------------column-------------------------------")
        print("datev_dict----------------------",datev_dict)
        return [
